...
echo  99.2 90 16 0 0 LM "(a)" | pstext -J${PROJ} -R${LATLON} -Gblack -O -P -V -K >> ${FNAME}
echo 104.2 90 16 0 0 LM P1 | pstext -J${PROJ} -R${LATLON} -Gblack -O -P -V  >> ${FNAME}
