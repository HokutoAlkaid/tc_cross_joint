...
psfile1="Fig6_checker_1.ps"

rm *.eps *.ps *.jpg *.tif

for i in 002 010 020
do
...
psimage 020km_init.eps -W7c -K > ${psfile1}
psimage 020km_invt.eps -W7c -C7.1c/0/BL -O -K >> ${psfile1}
psimage 010km_init.eps -W7c -C0/5.9c/BL -O -K >> ${psfile1}
psimage 010km_invt.eps -W7c -C7.1c/5.9c/BL -O -K  >> ${psfile1}
psimage 002km_init.eps -W7c -C0/11.8c/BL -O -K >> ${psfile1}
psimage 002km_invt.eps -W7c -C7.1c/11.8c/BL -O  >> ${psfile1}
