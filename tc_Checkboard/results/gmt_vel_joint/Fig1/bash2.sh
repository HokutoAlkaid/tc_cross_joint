...
psfile1="Fig6_checker_2.ps"

#rm *.eps *.ps *.jpg *.tif

for i in 030 040 050
do
...
psimage 040km_init.eps -W7c -C0/5.9c/BL -O -K >> ${psfile1}
psimage 040km_invt.eps -W7c -C7.1c/5.9c/BL -O -K  >> ${psfile1}
psimage 030km_init.eps -W7c -C0/11.8c/BL -O -K >> ${psfile1}
psimage 030km_invt.eps -W7c -C7.1c/11.8c/BL -O  >> ${psfile1}
