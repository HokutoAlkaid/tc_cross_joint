...
psclip psclip.txt -J${PROJ} -R${LATLON} -K -O -P >> ${FNAME}
...
#echo 100.2 23.7 20 0 0 CM $depth| gmt pstext -J${PROJ} -R${LATLON} -F+fblack -O -P -V -K >> ${FNAME}
echo 100.2 23.7 20 0 0 CM $depth| pstext -J${PROJ} -R${LATLON}  -O -P -V -K >> ${FNAME}
