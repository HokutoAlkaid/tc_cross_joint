program scale
  ...
  real ::la,lon,hscale,lscale,dscale
  ...
  hscale=maxval(vel)+0.1
  lscale=minval(vel)-0.1
  write(*,*) "lower and upper scales: "
  write(*,'(2f10.1)') lscale,hscale
  write(12,'(2f10.1)') lscale,hscale
