...
#---
gmt surface ${velfile} -G${grdfile}  -I2m/2m -R${LATLON} -Lld -Lud
...
echo $lscalev $hscalev > scale.dat
...
echo 102 2 20 0 0 LM "$depth"| gmt pstext -J${PROJ} -R${LATLON} -F+fblack -O -P  -V  >> ${FNAME}
